...
public class DrivetrainSubsystem extends SubsystemBase {
  ...
  public DrivetrainSubsystem() {
    ...
    m_odometry = new SwerveDriveOdometry(m_kinematics, new Rotation2d(0), null);
  ...
  public void resetOdometry(Pose2d pose) {
      m_odometry.resetPosition(getGyroscopeRotation(), new SwerveModulePosition[]{}, pose );
  }
  ...
  public void setStates(SwerveModuleState[] states) {
    ...
    m_odometry.update(getGyroscopeRotation(), new SwerveModulePosition[] {
    });
